              ...
              <div className="card-body">
                <div className="d-flex flex-column align-items-center text-center">
                  ...
                  <div className="mt-3">
                    ...
                    <p className="text-secondary profile-phrase">
                      {student?.Phrases}
                    </p>
                    <p className="text-muted font-size-sm profile-location">
                    ...
                    <Link href="/chatsPage">
                      <button className="btn btn-outline-info btn-message">
                        Message
                      </button>
                    </Link>
                  </div>
            ...
            <div className="card mb-3">
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-sm-9 text-secondary">{student?.name}</div>
                </div>
                <hr />
                <div className="row">
                  <div className="col-sm-3">
